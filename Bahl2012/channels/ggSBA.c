...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "pntproc");
 	...
 	ivoc_help("help ?1 ggSBA C:/Users/bpg/Desktop/Projects/Contextual Data Science/Projects/L5PC PID/Code/BahlEtAl2012 - BPG/channels/ggSBA.mod\n");
...
{
 { error =  oup();
 if(error){fprintf(stderr,"at line 141 in file ggSBA.mod:\n  \n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "ggSBA.mod";
static const char* nmodl_file_text = 
  "://=============================================================================\n"
