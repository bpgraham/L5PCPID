...
#define nrn_init _nrn_init__ihl
#define _nrn_initial _nrn_initial__ihl
#define nrn_cur _nrn_cur__ihl
#define _nrn_current _nrn_current__ihl
#define nrn_jacob _nrn_jacob__ihl
#define nrn_state _nrn_state__ihl
#define _net_receive _net_receive__ihl 
#define state state__ihl 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_ihl", _hoc_setdata,
 "alpha_ihl", _hoc_alpha,
 "beta_ihl", _hoc_beta,
 0, 0
};
#define alpha alpha_ihl
#define beta beta_ihl
 extern double alpha( _threadargsprotocomma_ double );
 extern double beta( _threadargsprotocomma_ double );
 /* declare global and static user variables */
#define gamma_ih gamma_ih_ihl
 double gamma_ih = 0;
#define seed seed_ihl
 double seed = 0;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 ihl C:/Users/bpg/Desktop/Projects/Contextual Data Science/Projects/L5PC PID/Code/BahlEtAl2012 - BPG/channels/hl.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Ihl-current";
...
#if NMODL_TEXT
static const char* nmodl_filename = "hl.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
  ...
  "\n"
  "ENDCOMMENT\n"
  ": Modified to include leak current as per Migliore & Migliore PLoS ONE 2012 (BPG 14-3-25)\n"
  ": (see M&M h.mod file)\n"
  "\n"
  "TITLE Ihl-current\n"
  "\n"
